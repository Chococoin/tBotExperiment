...
contract("Treasury", (accounts) => {
  ...
  it("Should assert if TreasuryBalance rises in outsourcing account.", async () => {
    ...
    const amount = web3.utils.toBN('1000000000000') 
    ...
    assert.equal(web3.utils.toBN(balance_1), web3.utils.toBN(balance_2) - amount, "TreasuryBalance rises to outsourcing account properly.")
  })
